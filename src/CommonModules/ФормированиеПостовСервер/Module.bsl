...
Функция СформироватьТекстПоста(Знач Пост) Экспорт
	...
	ИначеЕсли ТипЗнч(Произведение) = Тип("СправочникСсылка.Картины") И Пост.Сообщество = Справочники.Сообщества.ОИ Тогда
		
		Возврат СформироватьОписаниеКартины(Произведение);
...
Функция СформироватьОписаниеКартины(Знач Произведение)
	
	Возврат 
	"Ого, это же «"
	+ Произведение.Наименование
	+ "» "
	+ Произведение.Автор.Имя
	+ " "
	+ Произведение.Автор.Фамилия
	+ "! "
	+ Символы.ПС
	+ "Это картина в жанре "
	+ НРег(Произведение.Жанр.РодительныйПадеж)
	+ ", а её стиль - "
	+ НРег(Произведение.Стиль.Наименование)
	+ "!"
	+ Символы.ПС
	+ Символы.ПС
	+ Произведение.Стиль.Описание;
