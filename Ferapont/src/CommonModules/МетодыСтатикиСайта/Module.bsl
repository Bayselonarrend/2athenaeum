...
Процедура ОбновитьСтраницыАвторов(СписокАвторов) Экспорт
    ...
    Для Каждого Автор Из СписокАвторов Цикл
        ...
        ПоляАвтора          = ИнструментарийВызовСервера.ЗначенияРеквизитовОбъекта(Автор, "Имя,Фамилия,Код,ДР,Век");
		...
		ДеньРождения		= ?(ЗначениеЗаполнено(ПоляАвтора.ДР), Формат(ПоляАвтора.ДР, "ДЛФ=DD"), ПоляАвтора.Век);
        ...
        СтруктураАвтора.Вставить("date"    , ДеньРождения);
