...
Функция Запостить(Знач Пост = "", Знач СтруктураЗаписи = "", Знач Сообщество, Знач ЭтоРеклама = Ложь) Экспорт
	...
	ИначеЕсли 	Пост.ВидКартинки = Перечисления.ВидыКартинок.Одиночная 
...
Функция СделатьРепост(Знач Пост, Знач Сообщество = "") Экспорт
	...
	Возврат ВК_Апи.wall_repost(Параметры);
