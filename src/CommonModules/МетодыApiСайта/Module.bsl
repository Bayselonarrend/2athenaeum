...
Функция ВернутьДанныеПользователя(Знач Печенька) Экспорт
	...
	Если ВыборкаДетальныеЗаписи.Следующий() Тогда
		...
		СтруктураПользователя.Вставить("alert"		, ВыборкаДетальныеЗаписи.Оповещания);
...
Функция ВернутьСписокЧтения(Знач ПользовательИБ, Знач Количество = "", Знач Книга = "") Экспорт
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		НоваяКнига.Вставить("amount"	, СтрЗаменить(Строка(ВыборкаДетальныеЗаписи.ПрочитаноСлов), " ", ""));
		НоваяКнига.Вставить("total"		, СтрЗаменить(Строка(ВыборкаДетальныеЗаписи.ВсегоСлов), " ", ""));
