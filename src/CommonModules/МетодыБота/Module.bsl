...
//  *ИдентификаторПользователя - Строка - ИД
//  *ИдентификаторЧата - Строка - ИД чата
//  *ТекстСообщения - Строка - Текст
//  *ВидСоцСети - ПеречислениеСсылка.СоцСети - Соц сеть источник
//  *ИмяПользователя - Строка - Имя
//  *Секрет - Строка - Секретный токен (только для ВК)
//  *Никнейм - Строка - Ник пользователя
// 
// Возвращаемое значение:
//  Булево -  Обработать входящее сообщение
...
// Обработать изменение оповещений.
// 
// Параметры:
//  ID - Строка -  ID
//  СоцСеть - ПеречислениеСсылка.СоцСети -  Соц сеть
//  Текст - Строка -  Текст, содержащий информацию об изменении регулярности
// 
// Возвращаемое значение:
//  Строка -  Обработать изменение оповещений
Функция ОбработатьИзменениеОповещений(Знач ID, Знач СоцСеть, Знач Текст) Экспорт
	...
	Если ЗначениеЗаполнено(Пользователь) Тогда
		...
		НастройкиПользователя 	= ИнструментарийВызовСервера.ЗначениеРеквизитаОбъекта(Пользователь
