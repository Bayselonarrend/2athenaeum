...
Процедура ОбновитьКартинку()
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда	
		КартинкаСобытия = ПоместитьВоВременноеХранилище(РаботаССистемойСервер.СформироватьСобытие(Объект.Ссылка, Объект.Сообщество, Истина), Новый УникальныйИдентификатор);
	КонецЕсли;
