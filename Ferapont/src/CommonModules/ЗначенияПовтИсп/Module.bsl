...
Функция КэшируемаяКнига(Знач КодКниги) Экспорт
	...
	Возврат Справочники.Произведения.НайтиПоКоду(вРег(КодКниги));
	
КонецФункции

Функция КэшируемыйПользовательВК(Знач ИД) Экспорт
	
	Возврат Справочники.Пользователи.НайтиПоРеквизиту("VK", ИД);
	
КонецФункции

Функция КэшируемыйПользовательТелеграм(Знач ИД) Экспорт
	
	Возврат Справочники.Пользователи.НайтиПоРеквизиту("Telegram", ИД);
