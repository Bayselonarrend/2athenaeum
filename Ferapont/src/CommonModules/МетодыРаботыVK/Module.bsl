...
//  Сообщество - СправочникСсылка.Сообщества - Сообщество
//  Текст - Строка - Текст
//  IDПользователя - Число, Строка - ID пользователя
//  communitytoken - Строка - Communitytoken
//  Клавиатура - Строка -  Клавиатура JSON
//  Параметры - Структура Из Строка -  Параметры
// 
// Возвращаемое значение:
//  Произвольный -  Написать сообщение
...
//  ПодСообщением - Булево -  Под сообщением
//  КаждаяСНовойСтроки - Булево -  Каждая с новой строки
// 
// Возвращаемое значение:
//  Строка -  Сформировать клавиатуру
...
Функция ПолучитьСтандартныеПараметры(Знач Параметры = "", Знач Сообщество = "")
	...
	Возврат ЗначенияПовтИсп.КэшируемыеПараметрыСообществаВК(Параметры, Сообщество);
