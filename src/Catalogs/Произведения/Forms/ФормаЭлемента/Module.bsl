...
#Если НЕ ВебКлиент Тогда
  ...
  Если ВыбФайлы <> Неопределено Тогда
	  ...
	  Для Н = 0 По МаксимальныйНомер Цикл
		...
		ТекстСтрокой = СтрЗаменить(ТекстСтрокой, "&#" 	+ Строка(МаксимальныйНомер - Н) + ";", "");
		
		ТекстСтрокой = СтрЗаменить(ТекстСтрокой, Символы.ПС 
			+ Символы.ПС 
			+ "[" 	
			+ Строка(МаксимальныйНомер - Н) 
			+ "]" 
			+ Символы.ПС 
			+ Символы.ПС, "");
			
		ТекстСтрокой = СтрЗаменить(ТекстСтрокой, Символы.ПС + "[" 	+ Строка(МаксимальныйНомер - Н) + "]" + Символы.ПС, "");
		ТекстСтрокой = СтрЗаменить(ТекстСтрокой, "[" 	+ Строка(МаксимальныйНомер - Н) + "]", "");
