...
//@skip-check constructor-function-return-section, doc-comment-collection-item-type, doc-comment-ref-link, doc-comment-field-type
//@skip-check doc-comment-field-name, doc-comment-field-in-description-suggestion, structure-consructor-too-many-keys
