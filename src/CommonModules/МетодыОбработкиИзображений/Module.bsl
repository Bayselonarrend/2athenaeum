...
Функция СформироватьГалерею(Знач Картинка) Экспорт
	...
	"convert -resize 768x1152 """ + ВходнаяКартинка + РП + ОснованяКартинка + КП + Символы.ПС + 
	"convert -gravity Center -crop ""91%"" """ + ОснованяКартинка + РП + ОснованяКартинка + КП + Символы.ПС +  
	"convert -crop 768x768 """ + ОснованяКартинка + РП + ДопКартинка + КП 
	);
