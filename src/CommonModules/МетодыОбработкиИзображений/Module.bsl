...
Функция СформироватьЛекцию(Знач Аудио) Экспорт
	...
	РеквизитыЛекции = ИнструментарийВызовСервера.ЗначенияРеквизитовОбъекта(Аудио, "Источник,Наименование");	
	...
	+ "magick "
	+ ФотоВФ
	+ " -pointsize 40 -fill silver -font Tahoma -gravity West -annotate +650+123 '"
	+ Источник
	+ "' "
	+ ФотоВФ	
	);
